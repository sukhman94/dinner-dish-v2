...
Item1 = Item.create(name: 'Pizza', description: 'This is pizza', price: 850, status: 'publish',
                    category_ids: [Cat1.id, Cat4.id], restaurant_id: Restaurant1.id)
Item2 = Item.create(name: 'Burger1', description: 'This is Burger1', price: 480, status: 'publish',
                    category_ids: [Cat1.id], restaurant_id: Restaurant1.id)
Item3 = Item.create(name: 'Burger2', description: 'This is Burger2', price: 560, status: 'publish',
                    category_ids: [Cat1.id], restaurant_id: Restaurant1.id)
Item4 = Item.create(name: 'Chicken Karahi', description: 'Pakistani chicken karahi', price: 900, status: 'publish',
                    category_ids: [Cat5.id], restaurant_id: Restaurant1.id)
Item5 = Item.create(name: 'Manchurian', description: 'Chinese special', price: 350, status: 'publish',
                    category_ids: [Cat2.id], restaurant_id: Restaurant1.id)
Item6 = Item.create(name: 'Noodles', description: 'Chinese most favourite', price: 180, status: 'publish',
                    category_ids: [Cat2.id], restaurant_id: Restaurant2.id)
Item7 = Item.create(name: 'Biryani', description: 'Special chicken biryani', price: 250, status: 'publish',
                    category_ids: [Cat5.id], restaurant_id: Restaurant2.id)
Item8 = Item.create(name: 'Prawns', description: 'Continental', price: 2500, status: 'publish',
                    category_ids: [Cat2.id, Cat3.id], restaurant_id: Restaurant2.id)
Item9 = Item.create(name: 'Sweet Potato Pie', description: 'Continental', price: 1500, status: 'publish',
                    category_ids: [Cat3.id], restaurant_id: Restaurant2.id)
Item10 = Item.create(name: 'Chicken And Cheese Salad.', description: 'Continental', price: 1800, status: 'publish',
                     category_ids: [Cat3.id], restaurant_id: Restaurant2.id)
Item11 = Item.create(name: 'Margherita Pizza', description: 'Italian style pizza', price: 1150, status: 'publish',
                     category_ids: [Cat4.id], restaurant_id: Restaurant3.id)
Item12 = Item.create(name: 'Pasta Carbonara.', description: 'Italian special', price: 960, status: 'publish',
                     category_ids: [Cat4.id], restaurant_id: Restaurant3.id)
Item13 = Item.create(name: 'Chow Mein', description: 'Chinese', price: 280, status: 'publish',
                     category_ids: [Cat2.id], restaurant_id: Restaurant3.id)
Item14 = Item.create(name: 'Kung Pao Chicken', description: 'Served with fried rice', price: 280, status: 'publish',
                     category_ids: [Cat2.id], restaurant_id: Restaurant3.id)
Item15 = Item.create(name: 'Dumplings', description: 'Chinese', price: 120, status: 'publish',
                     category_ids: [Cat1.id, Cat4.id], restaurant_id: Restaurant4.id)
Item16 = Item.create(name: 'Nihari', description: 'Pakistans most favourite', price: 450, status: 'publish',
                     category_ids: [Cat2.id], restaurant_id: Restaurant4.id)
Item17 = Item.create(name: 'Halwa Puri.', description: 'Breakfast', price: 120, status: 'publish',
                     category_ids: [Cat1.id, Cat4.id], restaurant_id: Restaurant4.id)
Item18 = Item.create(name: 'Saag', description: 'Punjabi Special', price: 250, status: 'publish',
                     category_ids: [Cat5.id], restaurant_id: Restaurant5.id)
Item19 = Item.create(name: 'Lassi', description: 'This is pizza', price: 850, status: 'publish',
                     category_ids: [Cat5.id], restaurant_id: Restaurant5.id)
